...
{
    public class Company2DataStreamManager : IDeviceDataStreamManager
    {
        private readonly IDeviceDataHelper _deviceDataHelper;
        private readonly IServiceBusAdapter _serviceBusAdapter;
        private readonly ILogger<Company2DataStreamManager> _logger;
        private readonly EventContainersOptions _eventContainersOptions;

        public Company2DataStreamManager(IDeviceDataHelper deviceDataHelper,
            IServiceBusAdapter serviceBusAdapter,
            ILogger<Company2DataStreamManager>  logger,
        ...
        private readonly string COMPANY = "Company 2";
